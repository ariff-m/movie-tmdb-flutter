...
class NowPlayingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (viewModel.nowPlayingData == null && !viewModel.isLoading) {
    ...
    return Consumer<HomeViewModel>(
      builder: (context, viewModel, child) {
        return NotificationListener<ScrollNotification>(
          ...
          child: viewModel.isLoading && viewModel.nowPlayingData == null
              ? const LoadingWidget()
              : viewModel.nowPlayingData?.results == null ||
                      viewModel.nowPlayingData!.results.isEmpty
                  ...
                  : SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount:
                            viewModel.nowPlayingData?.results.length ?? 0,
                        itemBuilder: (context, index) {
                          final movie =
                              viewModel.nowPlayingData!.results[index];
                          final posterUrl =
